/*
Code adapted from https://forum.arduino.cc/t/how-to-use-the-adxl355-or-gy-61-accelrometer/331047
...
analog 3: z-axis
*/
const int xpin = 14;                  // x-axis of the accelerometer
const int ypin = 15;                  // y-axis
const int zpin = 16;                  // z-axis (only on 3-axis models)
void setup()
{
